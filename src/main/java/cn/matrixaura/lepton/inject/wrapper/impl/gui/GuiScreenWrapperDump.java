...
public class GuiScreenWrapperDump implements Opcodes {
    ...
    public static byte[] dump() throws Exception {
...

        {
            ...
            methodVisitor.visitMethodInsn(INVOKESPECIAL, obfGuiScreenClass, "<init>", "()V", false);
        ...
        }
        {
            ...
            methodVisitor.visitVarInsn(ILOAD, 1);
            methodVisitor.visitVarInsn(ILOAD, 2);
            methodVisitor.visitMethodInsn(INVOKESPECIAL, obfGuiScreenClass, "keyTyped", "(CI)V", false);
            Label label2 = new Label();
            methodVisitor.visitLabel(label2);
