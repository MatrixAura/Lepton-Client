...
public class DemoCheck extends CrashCheck {
    ...
    public boolean handle(Object packet) {
        if (PacketUtils.isPacketInstanceof(packet, "S2BPacketChangeGameState")) {
            return (Integer) ObjectUtils.invokeMethod(packet, Mappings.getObfMethod("func_149138_c")) == 5 && (Integer) ObjectUtils.invokeMethod(packet, Mappings.getObfMethod("func_149137_d")) == 0;
        }
