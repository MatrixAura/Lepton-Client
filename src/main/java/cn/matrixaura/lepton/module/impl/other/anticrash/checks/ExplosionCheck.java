...
public class ExplosionCheck extends CrashCheck {
    ...
    public boolean handle(Object packet) {
        if (PacketUtils.isPacketInstanceof(packet, "S27PacketExplosion")) {
            return (Byte) ObjectUtils.invokeMethod(packet, Mappings.getObfMethod("func_149149_c")) >= Byte.MAX_VALUE
                    || (Byte) ObjectUtils.invokeMethod(packet, Mappings.getObfMethod("func_149144_d")) >= Byte.MAX_VALUE
                    || (Byte) ObjectUtils.invokeMethod(packet, Mappings.getObfMethod("func_149147_e")) >= Byte.MAX_VALUE;
        }
